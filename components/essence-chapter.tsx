...
const pillars = [
  { title: 'Identidade', copy: 'Seu rosto. Sua história. O nosso ponto de partida.', Icon: UserRound },
  { title: 'Naturalidade', copy: 'Escolhas que valorizam a sua expressão, sem excessos.', Icon: Leaf },
  { title: 'Precisão', copy: 'Cada ponto tem propósito e parte de uma avaliação individual.', Icon: Heart },
];
  ...
  return <section id="manifesto" className="essence-editorial" ref={root} aria-labelledby="essence-title">
    <div className="essence-stage">
      ...
      <div className="essence-editorial-copy">
        ...
        <p className="essence-editorial-description" data-essence-motion="fade" data-delay="350">Cuidar do rosto é olhar para você: sua expressão, seus desejos e tudo o que torna a sua beleza única.</p>
      ...
      <figure className="essence-smile" data-essence-motion="photo">
        <Image src={site.images.essence} alt="Retrato da Dra. Giovanna Saroli." fill sizes="(max-width:700px) 112vw, (max-width:1100px) 82vw, 67vw"/>
      </figure>
